...
function gotResults(e,r){
    if(e){
      ...
      console.log(r);
      drawnSketch = r[0].label;
      confidence = Math.round(r[1].confidence*100)+'%';
      document.getElementById("currentSketch").innerHTML = 'Your Sketch:'+drawnSketch;
